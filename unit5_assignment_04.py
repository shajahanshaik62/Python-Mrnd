...
def test_left_binary_search_student():
    ...
    assert -1 == left_binary_search([1,4,6,7,8,9,9], 10)
    assert 0 == left_binary_search([1,1,2,4,5,8,8,8,8], 1)
    assert  8 == left_binary_search([3,4,5,6,7,8,9,10,11,11,11,11,11], 11)
