...
def test_numbers_arithmetic_operations():
    ...
    assert 2.3333333333333333335 == 7/3
...
1.KNOWING THE TYPE OF NUMBERS
2.DIFFERENT ARITHMETIC OPERATORS,AND DOING OPERATIONS USING TEM
3.CONVERTING STRINTGS TO NUMBERS AND VICE-VERSA AND CONVERSION OF NUMBERS INTO DIFFERENT BASES
"""